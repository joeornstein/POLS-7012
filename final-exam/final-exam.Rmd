...
- Include line segments between points as in the original figure (`geom_segment()`)
...
- "Institution and City Fixed Effects" just means to include institution and city in your model, but make sure that those variables are coded as characters (or factors) so `R` doesn't think they're numeric.
